...
module Rosegold::DataComponentTypes
  ...
  # Protocol 773 (MC 1.21.9 / 1.21.10) — 96 component types.
  # Same set/order as 772, but with the correct 40-43 ordering (the 772 table
  # above had a historical mis-order at those ids that has since been fixed).
  PROTOCOL_773 = {
    0_u32 => "custom_data", 1_u32 => "max_stack_size", 2_u32 => "max_damage",
    3_u32 => "damage", 4_u32 => "unbreakable", 5_u32 => "custom_name",
    6_u32 => "item_name", 7_u32 => "item_model", 8_u32 => "lore",
    ...
    34_u32 => "stored_enchantments", 35_u32 => "dyed_color", 36_u32 => "map_color",
    37_u32 => "map_id", 38_u32 => "map_decorations", 39_u32 => "map_post_processing",
    40_u32 => "charged_projectiles", 41_u32 => "bundle_contents", 42_u32 => "potion_contents",
    43_u32 => "potion_duration_scale", 44_u32 => "suspicious_stew_effects",
    45_u32 => "writable_book_content", 46_u32 => "written_book_content", 47_u32 => "trim",
    48_u32 => "debug_stick_state", 49_u32 => "entity_data", 50_u32 => "bucket_entity_data",
    51_u32 => "block_entity_data", 52_u32 => "instrument", 53_u32 => "provides_trim_material",
    54_u32 => "ominous_bottle_amplifier", 55_u32 => "jukebox_playable",
    56_u32 => "provides_banner_patterns", 57_u32 => "recipes", 58_u32 => "lodestone_tracker",
    59_u32 => "firework_explosion", 60_u32 => "fireworks", 61_u32 => "profile",
    62_u32 => "note_block_sound", 63_u32 => "banner_patterns", 64_u32 => "base_color",
    65_u32 => "pot_decorations", 66_u32 => "container", 67_u32 => "block_state",
    68_u32 => "bees", 69_u32 => "lock", 70_u32 => "container_loot", 71_u32 => "break_sound",
    72_u32 => "villager/variant", 73_u32 => "wolf/variant", 74_u32 => "wolf/sound_variant",
    75_u32 => "wolf/collar", 76_u32 => "fox/variant", 77_u32 => "salmon/size",
    78_u32 => "parrot/variant", 79_u32 => "tropical_fish/pattern",
    80_u32 => "tropical_fish/base_color", 81_u32 => "tropical_fish/pattern_color",
    82_u32 => "mooshroom/variant", 83_u32 => "rabbit/variant", 84_u32 => "pig/variant",
    85_u32 => "cow/variant", 86_u32 => "chicken/variant", 87_u32 => "frog/variant",
    88_u32 => "horse/variant", 89_u32 => "painting/variant", 90_u32 => "llama/variant",
    91_u32 => "axolotl/variant", 92_u32 => "cat/variant", 93_u32 => "cat/collar",
    94_u32 => "sheep/color", 95_u32 => "shulker/color",
  }
  ...
  def self.name_for(component_type : UInt32, protocol_version : UInt32) : String?
    if mapping = PROTOCOL_MAP[protocol_version]?
      ...
      {% begin %}PROTOCOL_{{Rosegold::ENABLED_PROTOCOLS.keys.sort.last}}[component_type]?{% end %}
    end
  end

  def self.id_for(name : String, protocol_version : UInt32) : UInt32?
    mapping = {% begin %}PROTOCOL_MAP[protocol_version]? || PROTOCOL_{{Rosegold::ENABLED_PROTOCOLS.keys.sort.last}}{% end %}
...
# sulfur_cube_content (26.2+): the block item a sulfur cube absorbed.
# Payload is a single ItemStackTemplate (item-then-count + component patch).
class Rosegold::DataComponents::SulfurCubeContent < Rosegold::DataComponent
  ...
  def self.read(io) : self
    new(Rosegold::Slot.read_item_stack_template(io))
  end

  def write(io) : Nil
    absorbed_block_item.write_item_stack_template(io)
  end
end
