...
class Rosegold::Clientbound::KnownPacks < Rosegold::Clientbound::Packet
  ...
  packet_ids({
    772_u32 => 0x0E_u32, # MC 1.21.8
    774_u32 => 0x0E_u32, # MC 1.21.11
    773_u32 => 0x0E_u32, # MC 1.21.9
    775_u32 => 0x0E_u32, # MC 26.1
    776_u32 => 0x0E_u32, # MC 26.2
  })
  ...
  def callback(client)
    ...
    # Empty response forces ViaBackwards to send full translated NBT data
    response = Rosegold::Serverbound::KnownPacks.new
