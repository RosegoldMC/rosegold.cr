...
- Most docs can be found at this link https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Protocol, but a local copy that is easier to parse is at ./game_assets/protocol_docs/1.21.8.wiki
